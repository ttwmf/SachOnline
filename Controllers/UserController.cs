...
namespace SachOnline.Controllers
{
    public class UserController : Controller
    {
        ...
        public ActionResult DangKy(FormCollection collection, KHACHHANG kh)
        {
            ...
            var sTenDN = collection["TenDN"]; var sMatKhau = collection["MatKhau"];
            var sMatKhauNhapLai = collection["MatKhauNL"]; var sDiaChi = collection["DiaChi"];
            ...
            {
                //Gán  giá  trị  cho  đối  tượng  được  tạo  mới  (kh) kh.HoTen  =  sHoTen;
                kh.TaiKhoan = sTenDN;
                kh.MatKhau = sMatKhau;
                kh.Email = sEmail;
                kh.DiaChi = sDiaChi;
        ...
        public ActionResult DangNhap(FormCollection collection)
        {
            ...
            else
            {
                ...
                if (kh != null)
                {
                    ...
                    Session["TaiKhoan"] = kh;
                    // Neu danh nhap tu navbar thi ?
                    // Neu dang nhap tu gio hang thi ?
                }
                else
                {
